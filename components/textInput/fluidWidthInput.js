export default function FluidWidthInput() {
    return (
        <>
            <h3>
                Fluid-width inputs
            ...
            <div>
                <label class="ds_label" for="fluid-75p">
                    Three quarters
                </label>
            ...
            <div>
                <label class="ds_label" for="fluid-67p">
                    Two thirds
                </label>
            ...
            <div>
                <label class="ds_label" for="fluid-50p">
                    Half
                </label>
            ...
            <div>
                <label class="ds_label" for="fluid-33p">
                    One third
                </label>
            ...
            <div>
                <label class="ds_label" for="fluid-25p">
                    One quarter
                </label>
