export default function FixedWidthInput() {
    return (
        <>
            <h3>
                Fixed-width inputs
            ...
            <div>
                <label class="ds_label" for="fixed-20">
                    20 characters
                </label>
            ...
            <div>
                <label class="ds_label" for="fixed-10">
                    10 characters
                </label>
            ...
            <div>
                <label class="ds_label" for="fixed-5">
                    5 characters
                </label>
            ...
            <div>
                <label class="ds_label" for="fixed-4">
                    4 characters
                </label>
            ...
            <div>
                <label class="ds_label" for="fixed-3">
                    3 characters
                </label>
            ...
            <div>
                <label class="ds_label" for="fixed-2">
                    2 characters
                </label>
