...
export default function Accordion() {
    return (
        <div class="ds_accordion" data-module="ds-accordion">
            <button data-accordion="accordion-open-all" type="button" class="ds_link  ds_accordion__open-all  js-open-all">
                Open all 
            ...
            <div class="ds_accordion-item">
                ...
                <div class="ds_accordion-item__body">
                    <p>
                        Veterans are entitled to the same healthcare as any citizen. And there are
                        <Link href={"#"}>
                            health care options and support
                        </Link>
