export default function CheckboxesNone() {
    return (
        <>
                ...
                <fieldset>
                    ...
                    <div class="ds_checkboxes" data-module="ds-checkboxes">
                        <div class="ds_checkbox">
                            ...
                            <label class="ds_checkbox__label" for="universal-credit">
                                Universal Credit
                            </label>
                        </div>
                        ...
                        <div class="ds_checkbox">
                            ...
                            <label class="ds_checkbox__label" for="pension-credit">
                                Pension Credit
                            </label>
                        </div>
                        ...
                        <div class="ds_checkbox">
                            ...
                            <label class="ds_checkbox__label" for="jsa">
                                Income-based Job Seeker's Allowance
                            </label>
                        </div>

                        <p class="ds_checkbox-separator">
                            or
                        </p>

                        <div class="ds_checkbox">
                            <input class="ds_checkbox__input" id="none" type="checkbox" data-behaviour="exclusive" />
                            <label class="ds_checkbox__label" for="none">
