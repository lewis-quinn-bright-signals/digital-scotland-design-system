export default function SmallCheckboxes() {
    return (
        <>
            <div class="ds_question">
                <fieldset aria-describedby="ds_hint">
                    ...
                    <p class="ds_hint-text" id="ds_hint">
                    ...
                    <div class="ds_field-group">
                        <div class="ds_checkbox  ds_checkbox--small">
                            ...
                            <label class="ds_checkbox__label" for="education">
                                Education
                            </label>
                        </div>
                        ...
                        <div class="ds_checkbox  ds_checkbox--small">
                            ...
                            <label class="ds_checkbox__label" for="housing">
                                Housing
                            </label>
                        </div>
                        ...
                        <div class="ds_checkbox  ds_checkbox--small">
                            ...
                            <label class="ds_checkbox__label" for="transport">
                                Transport
                            </label>
                        </div>
                    </div>
